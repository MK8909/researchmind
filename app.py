...
/* ══════════════════════════════════════════════
   GLOBAL MARKDOWN FIX — targets Streamlit's
   actual rendered DOM, not custom HTML wrappers
   ══════════════════════════════════════════════ */

/* Every text node inside any stMarkdown */
...
[data-testid="stMarkdownContainer"] label {
    ...
    -webkit-text-fill-color: #cdc8bf !important;
}
...
[data-testid="stMarkdownContainer"] b {
    ...
    -webkit-text-fill-color: #ff8c32 !important;
}
...
/* List markers */
[data-testid="stMarkdownContainer"] ol li::marker,
...
[data-testid="stMarkdownContainer"] a {
    ...
    text-decoration-color: rgba(255,140,50,0.4) !important;
}
...
.stTextInput > div > div > input::placeholder {
    ...
    -webkit-text-fill-color: #605850 !important;
    opacity: 1 !important;
}
...
[data-baseweb="input"] { background-color: #1a1a22 !important; }
...
if r:
    ...
    # ── Final report ──
    # Render the panel label via HTML, then markdown BELOW it (not inside it)
    if "writer" in r:
        st.markdown(
        ...
        # st.markdown renders AFTER the div above — that's fine, it sits below it visually
